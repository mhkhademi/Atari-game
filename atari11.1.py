...
def game_intro ():
    ...
    while intro:
        ...
        if 150 < mouse[0] < 150+100 and 450 < mouse[1] < 450+50:
            pygame.draw.rect(gameDisplay , green , (150,450,100,50) , border_radius=0 , border_top_left_radius=-1 , border_top_right_radius=-1 , border_bottom_left_radius=-1)
        else :
            pygame.draw.rect(gameDisplay , dGreen , (150,450,100,50) , border_radius=0 , border_top_left_radius=-1 , border_top_right_radius=-1 , border_bottom_left_radius=-1)
        smallText = pygame.font.Font('fonts\\freesansbold.ttf',20)
        TextSurf  = smallText.render("Play!",True,white)
        TextRect  = TextSurf.get_rect()
        TextRect.center = ((150+100/2),(450+50/2))
        gameDisplay.blit(TextSurf,TextRect)
        pygame.draw.rect(gameDisplay,red  ,(400+150,450,100,50))
